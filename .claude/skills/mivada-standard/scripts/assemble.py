...
MASTER = os.path.join(HERE, "..", "assets", "Mivada_Standard.pptx")
...
def assemble(name, keys, start=None, web=True, outdir=None):
    outdir = outdir or os.getcwd()           # outputs land in the caller's working dir
